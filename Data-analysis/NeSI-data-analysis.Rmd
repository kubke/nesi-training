...
Estimate number of total tech in Higher Ed by institution by using same approach as above. 
...
#total number of funded eps  (should be 6311.41)
total.eps <-sum(reshed$funded.ep) 
...
#calculate total tech per institution from funded evidence portfolio numbers

reshedall$tech.number <- as.numeric(reshedall$percent.funded.ep * hed.tech.number /100)
