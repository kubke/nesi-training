...
Most NeSI learners work at HED institutions, whereas CRI learners represent a larger proportion of their workforce. There are other learners from other institutions (eg, DOC, LINZ, etc).
...
Most NeSI learners in HED work in collaborating institutions, but this trend is not seen in CRIs. There was a large increase in HED learners in 2016/2017, whereas in CRIs most learners participated in 2016. 
...
ggplot(rescri, aes(x=reorder(institution,nesi.learner.total), y=nesi.learner.total, fill=relationship)) +
  geom_bar(stat="identity") + 
  theme(text = element_text(colour = "black", size=18))+
  ggtitle("# NeSI Learners by institution \n(CRI and other)")+
  ylab("Total number of learners")+
  xlab("")+
  coord_flip(ylim = c(0, 250))
...
NeSI learners in HED, represent a much smaller proportion of the HED workforce when compared to CRIs.
...
A large majority of HED institutions and CRIs participated in instructor training.
The delivery of NeSI-specific training seems to be limited and localized. 
...
ggplot(subset(nesi.training.all, institution.type %in% c("other", "?")), aes(x=institution, y=event.type, color = ..n.., size = ..n..)) +
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  xlab("")+ylab("")+
  labs(title = "Training participation by \nother government(?) institutions")+
  coord_flip()
...
It is interesting that the percentage of the workforse that uses NeSI is somewhat below the percentage of the workforce that receives training. However, most of the training participation is not NeSI specific.
...
```{r testbubble, echo=FALSE, eval = FALSE}
...
ggplot(nesi.use, aes(projects.2012, hours.2012, colour=discipline, size=researchers.2012))+ 
  geom_point()+
  xlab("projects")+
  ylab("hours")+
  ggtitle("2012")+
  scale_y_continuous(limits=c(0, 65800000))+
  scale_x_continuous(limits=c(0,300))
  ggsave("2012.png", width = 5, height = 5)
ggplot(nesi.use, aes(projects.2013, hours.2013, colour=discipline, size=researchers.2013))+ geom_point()+xlab("projects")+ylab("hours")+ggtitle("2013")+
    scale_y_continuous(limits=c(0, 65800000))+
  scale_x_continuous(limits=c(0,300))
 ggsave("2013.png", width = 5, height = 5)
ggplot(nesi.use, aes(projects.2014, hours.2014, colour=discipline, size=researchers.2014))+ geom_point()+xlab("projects")+ylab("hours")+ggtitle("2014")+
    scale_y_continuous(limits=c(0, 65800000))+
  scale_x_continuous(limits=c(0,300))
 ggsave("2014.png", width = 5, height = 5)
ggplot(nesi.use, aes(projects.2015, hours.2015, colour=discipline, size=researchers.2015))+ geom_point()+xlab("projects")+ylab("hours")+ggtitle("2015")+
    scale_y_continuous(limits=c(0, 65800000))+
  scale_x_continuous(limits=c(0,300))
 ggsave("2015.png", width = 5, height = 5)
ggplot(nesi.use, aes(projects.2016, hours.2016, colour=discipline, size=researchers.2016))+ geom_point()+xlab("projects")+ylab("hours")+ggtitle("2016")+
    scale_y_continuous(limits=c(0, 65800000))+
  scale_x_continuous(limits=c(0,300))
 ggsave("2016.png", width = 5, height = 5)


ggplot()+
  geom_point(data=nesi.use, aes(total.projects, total.hours, size = total.users, colour = discipline))
...
#  theme(text = element_text(colour = "black", size=16))+
#  xlab("")+
#  ylab("Number who attended training (all years)")+
...
ggplot(data=instructor.training, aes(x=reorder(organisation, checkout), y=checkout, fill=year)) +
  geom_bar(stat="identity") + 
  theme(text = element_text(colour = "black", size=16))+
  xlab("") +
...
ggplot(instructor.training, aes(x=reorder(organisation,checkout), y=completion.rate, fill=year)) +
  geom_bar(stat="identity") + 
  theme(text = element_text(colour = "black", size=16))+
  xlab("") +
  ylab("% who completed training")+
